...
namespace GatewayApiClient.ResourceClients.ResourceCielo {
    ...
    public class CreditCardResourceStoneCielo : BaseResourceCielo, ICreditCardResourceCielo
    {

        public CreditCardResourceStoneCielo(Guid merchantId, string merchantKey, Uri hostUri, NameValueCollection customHeaders) : base(merchantId, merchantKey, "/CreditCard", hostUri, customHeaders) { }

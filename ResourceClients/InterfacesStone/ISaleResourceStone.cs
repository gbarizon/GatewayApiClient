...
namespace GatewayApiClient.ResourceClients.InterfacesStone
{
    ...
    public interface ISaleResourceStone : IBaseResourceStone {
        ...
        /// <returns></returns>
        HttpResponse<CreateSaleResponse> Create(CreateSaleRequestStone createSaleRequestStone);
        ...
        /// <returns></returns>
        HttpResponse<CreateSaleResponse> Create(Collection<CreditCardTransactionStone> creditCardTransactionCollection, string orderReference);
        ...
        /// <param name="orderReference">Identificação do pedido na loja</param>
        /// <returns></returns>
        HttpResponse<CreateSaleResponse> Create(CreditCardTransactionStone creditCardTransaction, string orderReference);
        ...
        /// <param name="creditCardTransactionCollection">Coleção de transações de cartão de crédito</param>
        /// <returns></returns>
        HttpResponse<CreateSaleResponse> Create(Collection<CreditCardTransactionStone> creditCardTransactionCollection);
        ...
        /// <param name="creditCardTransaction">Dados da transação de cartão de crédito</param>
        /// <returns></returns>
        HttpResponse<CreateSaleResponse> Create(CreditCardTransactionStone creditCardTransaction);

...
namespace GatewayApiClient.ResourceClients {
    public class BuyerResourceStone : BaseResourceStone, IBuyerResourceStone {
        public BuyerResourceStone(Guid merchantKey, Uri hostUri, NameValueCollection customHeaders) : base(merchantKey, "/Buyer", hostUri, customHeaders) { }

...
namespace GatewayApiClient.Tests {
    [TestClass]
    public class GatewayServiceClientStoneTests : BaseTests {
        ...
        #region Variables
        private readonly CreateSaleRequestStone _createCreditCardSaleRequestStone = new CreateSaleRequestStone {
        ...
        private readonly CreditCardTransactionStone _createSingleCreditCardTransaction = new CreditCardTransactionStone
        {
            CreditCard = new CreditCardStone {
                CreditCardNumber = "4111111111111111",
                CreditCardBrand = CreditCardBrandEnum.Visa,
        ...
        private IGatewayServiceClientStone GetGatewayServiceClient() {

            return new GatewayServiceClientStone(MerchantKey, _endpoint);
        }
    }
}

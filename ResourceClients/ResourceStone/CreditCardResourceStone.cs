...
namespace GatewayApiClient.ResourceClients.ResourceStone {
    ...
    public class CreditCardResourceStoneStone : BaseResourceStone, ICreditCardResourceStone {

        public CreditCardResourceStoneStone(Guid merchantKey, Uri hostUri, NameValueCollection customHeaders) : base(merchantKey, "/CreditCard", hostUri, customHeaders) { }

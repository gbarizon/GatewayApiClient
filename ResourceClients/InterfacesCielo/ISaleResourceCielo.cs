...
namespace GatewayApiClient.ResourceClients.InterfacesCielo {
    ...
    public interface ISaleResourceCielo : IBaseResourceCielo {
        ...
        /// </summary>
        /// <param name="createSaleRequestCielo">Dados da venda</param>
        /// <returns></returns>
        HttpResponse<CreateSaleResponse> Create(CreateSaleRequestCielo createSaleRequestCielo);
        ...
        /// <returns></returns>
        HttpResponse<CreateSaleResponse> Create(Collection<CreditCardTransactionCielo> creditCardTransactionCollection, string orderReference);
        ...
        /// <param name="orderReference">Identificação do pedido na loja</param>
        /// <returns></returns>
        HttpResponse<CreateSaleResponse> Create(CreditCardTransactionCielo creditCardTransaction, string orderReference);
        ...
        /// <param name="creditCardTransactionCollection">Coleção de transações de cartão de crédito</param>
        /// <returns></returns>
        HttpResponse<CreateSaleResponse> Create(Collection<CreditCardTransactionCielo> creditCardTransactionCollection);
        ...
        /// <param name="creditCardTransaction">Dados da transação de cartão de crédito</param>
        /// <returns></returns>
        HttpResponse<CreateSaleResponse> Create(CreditCardTransactionCielo creditCardTransaction);

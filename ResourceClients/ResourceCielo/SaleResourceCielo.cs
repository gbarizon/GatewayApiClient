...
namespace GatewayApiClient.ResourceClients.ResourceCielo
{
    ...
    public class SaleResourceCielo : BaseResourceCielo, ISaleResourceCielo
    {

        public SaleResourceCielo(Guid merchantId, string merchantKey, Uri hostUri, NameValueCollection customHeaders) : base(merchantId, merchantKey, "/Sale", hostUri, customHeaders) { }
        ...
        public HttpResponse<CreateSaleResponse> Create(CreditCardTransactionCielo creditCardTransaction, string orderReference)
        {
            ...
            var creditCardTransactionCollection = new Collection<CreditCardTransactionCielo> { creditCardTransaction };
        ...
        /// <param name="creditCardTransactionCollection">Coleção de transações de cartão de crédito</param>
        /// <returns></returns>
        public HttpResponse<CreateSaleResponse> Create(Collection<CreditCardTransactionCielo> creditCardTransactionCollection)
        {
        ...
        public HttpResponse<ManageSaleResponse> Manage(ManageOperationEnum manageOperation, Guid orderKey)
        {
            ...
            ManageSaleRequest manageSaleRequest = new ManageSaleRequest { OrderKey = orderKey };
        ...
        public HttpResponse<ManageSaleResponse> Manage(ManageOperationEnum manageOperation, Guid orderKey, Collection<ManageCreditCardTransaction> manageCreditCardTransactionCollection)
        {
            ...
            {
                OrderKey = orderKey,
                CreditCardTransactionCollection = manageCreditCardTransactionCollection
            };
        ...
        public HttpResponse<RetrySaleResponse> Retry(Guid orderKey)
        {
            ...
            RetrySaleRequest retrySaleRequest = new RetrySaleRequest { OrderKey = orderKey };
        ...
        public HttpResponse<RetrySaleResponse> Retry(Guid orderKey, Collection<RetrySaleCreditCardTransaction> retrySaleCreditCardTransactionCollection)
        {
            ...
            {
                OrderKey = orderKey,
                RetrySaleCreditCardTransactionCollection = retrySaleCreditCardTransactionCollection
            };
        ...
        public HttpResponse<RetrySaleResponse> Retry(Guid orderKey, RetrySaleCreditCardTransaction retrySaleCreditCardTransaction)
        {
            ...
            Collection<RetrySaleCreditCardTransaction> retrySaleCreditCardTransactionCollection =
                new Collection<RetrySaleCreditCardTransaction> { retrySaleCreditCardTransaction };
